...
## ![Logo LightMode](public/assets/imgs/logos/logoescura.svg#gh-light-mode-only)![Logo DarkMode](public/assets/imgs/logos/logobranca.svg#gh-dark-mode-only)
...
![Modelo Casos de Uso](public/assets/imgs/diagama_images/PI-Conecte_useCase.png)
